...
properties:
  ...
  path_sumStats:
    title: "GWAS sumstats"
    description: |
      Name of the sumstats file to clean that is in the same directory as the
      metadata file. This file must be located in the same directory as the
      metadata file, be gzipped and have the file extensio `.gz`.
    type: "string"
  ...
  study_PhenoCode:
    ...
    description: |
      List of phenotypes in the format of [EFO](https://www.ebi.ac.uk/efo/) codes:
